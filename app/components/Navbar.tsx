...
export default function Navbar() {
  ...
  return (
    <Disclosure
      as="nav"
      className="bg-white shadow-md text-black sticky top-0 z-50"
    >
      {({ open, close }) => (
        <>
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <li key={link.name} className="relative group">
                    ...
                    {/* underline */}
                    <span
                      className={`absolute left-0 -bottom-1 h-0.5 w-full transform origin-left transition-transform duration-300 ${
                        isActive
